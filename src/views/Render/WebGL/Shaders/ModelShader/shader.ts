...
export default class ModelShader {
  ...
  constructor() {
    ...
    this.tangentAttribute = GLM.getAttributeLocation(
      program,
      Locations.TANGENT
    );
    ...
    this.colorAttribute = GLM.getAttributeLocation(
      program,
      Locations.VERTEX_COLOR
    );
    this.diffuseTexture = GLM.getUniformLocation(
      program,
      Locations.DIFFUSE_TEXTURE
    );
    this.normalMapTexture = GLM.getUniformLocation(
      program,
      Locations.NORMAL_MAP_TEXTURE
    );
